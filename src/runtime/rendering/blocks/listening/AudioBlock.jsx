                ...
                <div className="elab-block-interactive-side">
                    ...
                    <div className="elab-custom-header">
                        <div className="elab-header-content">
                            <h3 className="elab-block-title" style={{ display: "inline-flex", background: "var(--theme-heading-board, url('/purple board.png')) no-repeat", backgroundSize: "100% 100%", padding: "10px 32px", color: "#ffffff", height: "52px", alignItems: "center", justifyContent: "center" }}>
